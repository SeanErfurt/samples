//JHUHashMap interface file, revised 30 Oct 14 at 3:30pm.
//Change Log:
//   -- removed erroneous paragraph from the javadoc description of put.
//
...
public interface JHUHashMap<K, V> {
     ...
     *         previous mapping for key. (A null return value can also indicate
     ...
     * null values are permitted in this map. Use containsKey to distinguish the
    ...
    /**
     * Remove all of the mappings from this map. The map will be empty after
     * this call returns.
     */
    void clear();
